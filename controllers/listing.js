...
module.exports.renderEditform=async (req,res)=>{
    ...
    if(!listing){
        req.flash("error","Listing you are trying to Edit not found!");
        res.redirect("/listings");
    }
...
module.exports.updateListing=async (req, res) => {
    ...
    let existingImage = listing.image;

    listing= await Listing.findByIdAndUpdate(id, { ...req.body.listing , image: existingImage },{ new: true });
